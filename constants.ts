...
export const TRANSLATIONS = {
  en: {
    heroTitle: "We Have Products Below:",
    heroSubtitle:
      "I am selling these quality items. If you need them, please contact my Telegram or order by adding to the basket.",
    shopNow: "Shop Now",
    ...
    legal: "Legal",
    handcrafted:
      "Locally sourced and homemade with care. Quality you can trust.",
  ...
  km: {
    heroTitle: "យើងខ្ញុំមានផលិតផលដូចខាងក្រោម៖",
    heroSubtitle:
      "ប្រសិនបើលោកអ្នកត្រូវការ សូមទំនាក់ទំនងមកកាន់ Telegram របស់ខ្ញុំ ឬកម្មង់តាមរយៈការដាក់ចូលក្នុងកន្ត្រក។",
    shopNow: "មើលផលិតផល",
...
export const INITIAL_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description_km: "រសជាតិស្រួយ ផ្អែមឆ្ងាញ់",
    image: "https://i.imgur.com/dKNhKM1.jpeg",
    images: [
      "https://i.imgur.com/dKNhKM1.jpeg",
      "https://i.imgur.com/4MmF4jO.jpeg",
      "https://i.imgur.com/GMoy3VP.jpeg",
    ],
    scent: "Jujube",
    scent_km: "ក្លិនពុទ្រ្ទាធម្មជាតិ",
    ingredients: "Natural Jujube",
    ingredients_km: "ពុទ្រ្ទាធម្មជាតិមកពីខេត្តពោធិ៍សាត់",
  },
];
